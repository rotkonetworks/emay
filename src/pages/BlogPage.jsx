...
export default function BlogPage() {
 ...
 <div class="flex-1">
 <h2 class="text-2xl font-bold text-foreground transition-colors group-hover:text-primary mb-2">
 {post.title}
 </h2>
 ...
 <div class="i-lucide-arrow-right h-5 w-5 text-muted-foreground transition-colors group-hover:text-primary flex-shrink-0 mt-1" />
 </div>
 </SharpCard>
 </a>
 )}

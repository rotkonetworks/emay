...
export function SimplePricingSection() {
 ...
 return (
 <section id="pricing" class="bg-accent/10 py-16 lg:py-24 scroll-mt-20">
 ...
 <div class="mb-4 inline-flex h-12 w-12 items-center justify-center bg-primary/10 text-primary">

...
export function SupportSection(props) {
  ...
  return (
    <section id="support" class="bg-emay-lime/5 dark:bg-dark-green-field/10 py-16 lg:py-24 scroll-mt-20">
            ...
            {(card) => (
              <div>
                <SharpCard class="bg-card text-center h-full flex flex-col">
                  ...
                  <Button
                    variant="link"
                    class="p-0 font-semibold text-emay-pink hover:text-emay-pink/80"

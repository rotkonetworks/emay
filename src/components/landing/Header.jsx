...
export function Header() {
 ...
 class="px-4 py-2 text-sm font-medium text-foreground bg-card border-2 border-border shadow-sharp transition-all duration-200 ease-in-out hover:shadow-none hover:translate-x-1 hover:translate-y-1 hover:bg-primary hover:text-primary-foreground"
 >
 {link.label}
 </button>
 )}
 ...
 <Button
 class="hidden lg:block text-white bg-primary border-2 border-border shadow-sharp transition-all hover:shadow-none hover:translate-x-1 hover:translate-y-1 hover:bg-primary/90"
 ...
 <button
 onClick={() => handleNavClick(link.href)}
 class="px-4 py-3 text-base font-medium text-foreground bg-card border-2 border-border shadow-sharp transition-all duration-200 ease-in-out hover:shadow-none hover:translate-x-1 hover:translate-y-1 hover:bg-primary hover:text-white text-left"
 >
 {link.label}
 </button>
 )}
 </For>
 <Button class="text-white bg-primary border-2 border-border shadow-sharp transition-all hover:shadow-none hover:translate-x-1 hover:translate-y-1 hover:bg-primary/90">
 {t('nav.getStarted')}
 </Button>
 </div>
 </div>

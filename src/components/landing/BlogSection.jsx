    ...
    <section class="bg-background py-16 lg:py-24">
      <div class="container mx-auto px-4">
              ...
              <article>
                <a href={`/${locale()}/blog/${post.slug}`} class="block group h-full">
                  <SharpCard class="bg-card h-full flex flex-col">
                    <div class="flex-1">
                      <h3 class="text-xl font-bold text-foreground transition-colors group-hover:text-emay-pink mb-3 line-clamp-2">
                        {post.title}
                      </h3>
                    ...
                    <div class="flex items-center justify-between text-sm text-muted-foreground mt-auto">
                      ...
                      <div class="i-lucide-arrow-right h-4 w-4 transition-colors group-hover:text-emay-pink flex-shrink-0" />
                    </div>
                  </SharpCard>
                </a>
              </article>
        ...
        <div class="mt-12 text-center">
          <Button
            variant="outline"
            class="bg-card border-2 border-black shadow-sharp transition-all hover:shadow-none hover:translate-x-1 hover:translate-y-1 hover:bg-emay-pink hover:text-white"

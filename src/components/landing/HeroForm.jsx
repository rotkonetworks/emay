    ...
    <>
      <div class="w-full max-w-lg">
        <form
          ...
          class="flex items-center gap-0 bg-card p-0 border-2 border-black shadow-sharp"
        >
          ...
          <Button
            type="submit"
            size="lg"
            class="h-12 flex-shrink-0 rounded-none px-6 text-base font-semibold text-white bg-emay-pink border-l-2 border-black shadow-none transition-colors hover:bg-emay-pink/90"
          >

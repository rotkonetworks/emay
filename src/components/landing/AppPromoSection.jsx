...
export function AppPromoSection() {
 ...
 return (
 <section class="bg-primary/5 py-16 lg:py-24">
 ...
 class="h-12 text-base bg-card border-2 border-border text-foreground placeholder:text-muted-foreground"
 aria-label="Email for app notification"
 />
 <Button
 size="lg"
 class="h-12 bg-primary text-primary-foreground transition-colors hover:bg-primary/90 border-2 border-border shadow-sharp hover:shadow-none hover:translate-x-1 hover:translate-y-1"
 >
 {t('app.notifyMe')}
 </Button>
 </form>
